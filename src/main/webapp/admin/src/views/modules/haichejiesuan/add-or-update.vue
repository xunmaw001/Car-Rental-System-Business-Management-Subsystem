<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出租价格" prop="chuzujiage">
          <el-input v-model="ruleForm.chuzujiage" 
              placeholder="出租价格" clearable  :readonly="ro.chuzujiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出租价格" prop="chuzujiage">
              <el-input v-model="ruleForm.chuzujiage" 
                placeholder="出租价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="续租租金" prop="xuzuzujin">
          <el-input v-model="ruleForm.xuzuzujin" 
              placeholder="续租租金" clearable  :readonly="ro.xuzuzujin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="续租租金" prop="xuzuzujin">
              <el-input v-model="ruleForm.xuzuzujin" 
                placeholder="续租租金" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="事故费" prop="shigufei">
          <el-input v-model="ruleForm.shigufei" 
              placeholder="事故费" clearable  :readonly="ro.shigufei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="事故费" prop="shigufei">
              <el-input v-model="ruleForm.shigufei" 
                placeholder="事故费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="罚金费" prop="fajinfei">
          <el-input v-model="ruleForm.fajinfei" 
              placeholder="罚金费" clearable  :readonly="ro.fajinfei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="罚金费" prop="fajinfei">
              <el-input v-model="ruleForm.fajinfei" 
                placeholder="罚金费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="总额" prop="zonge">
            <el-input v-model="zonge"
                placeholder="总额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zonge" label="总额" prop="zonge">
              <el-input v-model="ruleForm.zonge" 
                placeholder="总额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
    zonge: {
      get: function () {
        return 0+parseFloat(this.ruleForm.chuzujiage==""?0:this.ruleForm.chuzujiage)+parseFloat(this.ruleForm.xuzuzujin==""?0:this.ruleForm.xuzuzujin)+parseFloat(this.ruleForm.shigufei==""?0:this.ruleForm.shigufei)+parseFloat(this.ruleForm.fajinfei==""?0:this.ruleForm.fajinfei)+parseFloat(this.ruleForm.qitafeiyong==""?0:this.ruleForm.qitafeiyong) || 0
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cheliangyanse = true;
          ...
          if(o=='chuzujiage'){
            this.ruleForm.chuzujiage = obj[o];
	    this.ro.chuzujiage = true;
            continue;
          }
          if(o=='xuzuzujin'){
            this.ruleForm.xuzuzujin = obj[o];
	    this.ro.xuzuzujin = true;
            continue;
          }
          if(o=='shigufei'){
            this.ruleForm.shigufei = obj[o];
	    this.ro.shigufei = true;
            continue;
          }
          if(o=='fajinfei'){
            this.ruleForm.fajinfei = obj[o];
	    this.ro.fajinfei = true;
            continue;
          }
          if(o=='qitafeiyong'){
    ...
    onSubmit() {
      ...
      // ${column.compare}
      // ${column.compare}
        this.ruleForm.zonge = this.zonge
      // ${column.compare}
      // ${column.compare}
      // ${column.compare}
      // ${column.compare}
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `haichejiesuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.haichejiesuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
