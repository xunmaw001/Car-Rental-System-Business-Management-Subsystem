<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出租状态" prop="chuzuzhuangtai">
          <el-input v-model="ruleForm.chuzuzhuangtai" 
              placeholder="出租状态" clearable  :readonly="ro.chuzuzhuangtai"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="合同" prop="hetong">
          <file-upload
          tip="点击上传合同"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.hetong" label="合同" prop="hetong">
            <el-button type="text" size="small" @click="download(ruleForm.hetong)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出租价格" prop="chuzujiage">
            <el-input v-model="chuzujiage"
                placeholder="出租价格" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chuzujiage" label="出租价格" prop="chuzujiage">
...
export default {
  ...
  computed: {
    chuzujiage:{
      get: function () {
        return 1*this.ruleForm.rizujin*this.ruleForm.shiyongtianshu
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.rizujin = true;
          ...
          if(o=='shiyongtianshu'){
            this.ruleForm.shiyongtianshu = obj[o];
	    this.ro.shiyongtianshu = true;
            continue;
          }
          if(o=='chuzujiage'){
    ...
    onSubmit() {
      ...
      // ${column.compare}
      // ${column.compare}
        this.ruleForm.chuzujiage = this.chuzujiage
