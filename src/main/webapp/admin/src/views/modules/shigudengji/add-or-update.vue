    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="事故起因" prop="shiguqiyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="事故起因"
                  v-model="ruleForm.shiguqiyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shiguqiyin" label="事故起因" prop="shiguqiyin">
                    <span>{{ruleForm.shiguqiyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="调查结果" prop="diaochajieguo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="调查结果"
                  v-model="ruleForm.diaochajieguo" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.diaochajieguo" label="调查结果" prop="diaochajieguo">
                    <span>{{ruleForm.diaochajieguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cheliangyanse = true;
          ...
          if(o=='shiguqiyin'){
            this.ruleForm.shiguqiyin = obj[o];
	    this.ro.shiguqiyin = true;
            continue;
          }
          if(o=='shijian'){
	    ...
	    this.ro.shijian = true;
          ...
          if(o=='diaochajieguo'){
            this.ruleForm.diaochajieguo = obj[o];
	    this.ro.diaochajieguo = true;
            continue;
          }
          if(o=='tupian'){
