<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车辆押金" prop="cheliangyajin">
          <el-input v-model="ruleForm.cheliangyajin" 
              placeholder="车辆押金" clearable  :readonly="ro.cheliangyajin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车辆押金" prop="cheliangyajin">
              <el-input v-model="ruleForm.cheliangyajin" 
                placeholder="车辆押金" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="出租状态" prop="chuzuzhuangtai">
          <el-select v-model="ruleForm.chuzuzhuangtai" placeholder="请选择出租状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="出租状态" prop="chuzuzhuangtai">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="日租金" prop="rizujin">
          <el-input v-model="ruleForm.rizujin" 
              placeholder="日租金" clearable  :readonly="ro.rizujin"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="续租天数" prop="xuzutianshu">
          <el-input v-model="ruleForm.xuzutianshu" 
              placeholder="续租天数" clearable  :readonly="ro.xuzutianshu"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="续租租金" prop="xuzuzujin">
            <el-input v-model="xuzuzujin"
                placeholder="续租租金" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xuzuzujin" label="续租租金" prop="xuzuzujin">
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="车辆描述" prop="cheliangmiaoshu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="车辆描述"
                  v-model="ruleForm.cheliangmiaoshu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.cheliangmiaoshu" label="车辆描述" prop="cheliangmiaoshu">
                    <span>{{ruleForm.cheliangmiaoshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  computed: {
    xuzuzujin:{
      get: function () {
        return 1*this.ruleForm.rizujin*this.ruleForm.xuzutianshu
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cheliangyanse = true;
          ...
          if(o=='cheliangyajin'){
            this.ruleForm.cheliangyajin = obj[o];
	    this.ro.cheliangyajin = true;
            continue;
          }
          if(o=='chuzujiage'){
	    ...
	    this.ro.chuzuzhuangtai = true;
          ...
          if(o=='cheliangmiaoshu'){
            this.ruleForm.cheliangmiaoshu = obj[o];
	    this.ro.cheliangmiaoshu = true;
            continue;
          }
          if(o=='tupian'){
    ...
    onSubmit() {
      ...
      // ${column.compare}
      // ${column.compare}
        this.ruleForm.xuzuzujin = this.xuzuzujin
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `qichexuzu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qichexuzuCrossAddOrUpdateFlag = false;
                  this.parent.search();
