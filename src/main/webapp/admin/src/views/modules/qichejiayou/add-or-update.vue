<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="汽油型号" prop="qiyouxinghao">
          <el-input v-model="ruleForm.qiyouxinghao" 
              placeholder="汽油型号" clearable  :readonly="ro.qiyouxinghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="汽油型号" prop="qiyouxinghao">
              <el-input v-model="ruleForm.qiyouxinghao" 
                placeholder="汽油型号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cheliangyanse = true;
          ...
          if(o=='qiyouxinghao'){
            this.ruleForm.qiyouxinghao = obj[o];
	    this.ro.qiyouxinghao = true;
            continue;
          }
          if(o=='riqi'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `qichejiayou/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qichejiayouCrossAddOrUpdateFlag = false;
                  this.parent.search();
